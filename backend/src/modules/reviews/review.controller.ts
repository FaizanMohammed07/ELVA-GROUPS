...
export const ReviewController = {
  async getProductReviews(req: Request, res: Response): Promise<void> {
    ...
    const reviews = await ReviewModel.find({ productId: req.params["productId"] as string, isApproved: true })
  ...
  async getReviewSummary(req: Request, res: Response): Promise<void> {
    const reviews = await ReviewModel.find({ productId: req.params["productId"] as string, isApproved: true }, 'rating');
